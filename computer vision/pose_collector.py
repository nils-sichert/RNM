...
class pose_collector():
    ...
    def __init__(self):
        self.save_path_collected_joint_list = "/home/rnm/catkin_ws/src/panda/panda_vision/scripts/joint_list/camera_calibration/"
    ...
    def position_reached_callback(self, data):
        ...
        cv.imwrite(self.path_rgb + "rgb_" + str(self.counter) + ".png", self.current_rgb_frame) 
        cv.imwrite(self.path_ir + "ir_" + str(self.counter) + ".png", self.current_ir_frame)
        self.counter += 1 
    ...
    def save_collected_joint_list(self):
        ...
        np.save(self.save_path_collected_joint_list + "collected_joint_list.npy", self.collected_joint_list)
